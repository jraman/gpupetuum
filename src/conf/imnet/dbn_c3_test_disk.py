...
or diskbatch (mini-batch with data on disk and transferred back and forth to GPU memory)

Usage:
$ python theanodbn/runners/run_dbn_rambatch.py <path/to/thisfile>   # disk
